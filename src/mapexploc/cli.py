...
def train(
    ...
    data_path: Optional[Path] = typer.Option(
        None, help="Path to training data CSV. Defaults to examples/data/example_sequences.csv"
    ),
    ...
    if data_path is None:
        ...
        if not data_path.exists():
             typer.echo(f"Default data file not found at {data_path}. Please specify --data-path.", err=True)
